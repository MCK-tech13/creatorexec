    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/20 p-4 backdrop-blur-sm">
      <div className="card-panel w-full max-w-md p-6">
        <div className="mb-5 flex items-center justify-between">
          <h3 className="font-heading text-xl font-semibold text-ink">Add Product Manually</h3>
          <button
            type="button"
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <label className="block">
            <span className="mb-1 block font-sans text-sm text-stone">Product Name</span>
            <input
              type="text"
              value={productName}
          ...
          <label className="block">
            <span className="mb-1 block font-sans text-sm text-stone">Commission Amount ($)</span>
            <input
              type="number"
              min={0}
              step={0.01}
          ...
          <label className="block">
            <span className="mb-1 block font-sans text-sm text-stone">Tier</span>
            <select
              value={tier}
          ...
          <label className="block">
            <span className="mb-1 block font-sans text-sm text-stone">Videos Filmed</span>
            <input
              type="number"
              min={0}
              value={videosFilmed}
