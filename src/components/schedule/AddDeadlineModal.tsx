    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/90 p-4">
      <div className="card-panel w-full max-w-md p-10">
        <div className="mb-8 flex items-center justify-between">
          <h3 className="font-display text-xl font-bold text-ink">Add Sample / Deadline</h3>
          <button
            type="button"
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="label-caps mb-3 block">Product Name</label>
            <input
              required
          ...
          <div>
            <label className="label-caps mb-3 block">Brand</label>
            <input
              value={form.brand}
          ...
          <div>
            <label className="label-caps mb-3 block">Deadline Date</label>
            <input
              required
              type="date"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="label-caps mb-3 block">Videos Required</label>
              <input
                type="number"
                min={1}
            ...
            <div>
              <label className="label-caps mb-3 block">Videos Filmed</label>
              <input
                type="number"
                min={0}
